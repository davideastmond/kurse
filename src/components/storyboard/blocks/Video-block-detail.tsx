      ...
      <div className="mt-4 space-y-4">
        <div className="flex items-start justify-between gap-3">
          <input
            ...
            className="w-full rounded-lg border border-border bg-surface px-3 py-2 text-xl font-semibold text-foreground placeholder:text-muted-foreground/70 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500"
        ...
        <div className="space-y-4 rounded-3xl border border-sky-200 bg-sky-50/60 p-4">
          <div>
            ...
            <input
              ...
              className="mt-1 w-full rounded-lg border border-border bg-surface px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground/70 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500"
          ...
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full cursor-pointer rounded-lg border border-sky-200 bg-surface px-3 py-2 text-sm text-muted-foreground file:mr-3 file:rounded-md file:border-0 file:bg-sky-100 file:px-3 file:py-1.5 file:text-xs file:font-semibold file:uppercase file:tracking-[0.12em] file:text-sky-700 hover:file:bg-sky-200 disabled:cursor-not-allowed disabled:opacity-60"
            />
          </div>
          ...
          {videoLink ? (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex rounded-lg border border-sky-200 bg-surface px-3 py-2 text-xs font-semibold uppercase tracking-[0.16em] text-sky-700 transition-colors hover:bg-sky-100"
            >
