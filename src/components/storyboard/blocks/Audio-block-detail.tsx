  ...
  const audioCanvas = (
    <div className="space-y-4 rounded-3xl border border-amber-200 bg-amber-50/60 p-4">
      ...
      <input
        ...
        className="block w-full cursor-pointer rounded-lg border border-amber-200 bg-white px-3 py-2 text-sm text-slate-700 file:mr-3 file:rounded-md file:border-0 file:bg-amber-100 file:px-3 file:py-1.5 file:text-xs file:font-semibold file:uppercase file:tracking-[0.12em] file:text-amber-700 hover:file:bg-amber-200 disabled:cursor-not-allowed disabled:opacity-60"
      />
      ...
      <div className="mt-4 space-y-4">
        <div className="flex items-start justify-between gap-3">
          <input
            ...
            className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xl font-semibold text-slate-950 placeholder-slate-400 focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500"
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="mt-1 w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm text-slate-950 placeholder-slate-400 focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500"
